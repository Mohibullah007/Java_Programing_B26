...
public class Library {
    public static void main(String[] args) {
        ...
        // using the update Author information

        Book obj4 = new Book();
        obj4.author = new Author("JK Rowling",
                40); // made an author object it belongs
        // -> to the Book obj4 object
        System.out.println(obj4.author);
        System.out.println(obj4.author.getName());

        // Author author = new Author(); here you are making
        // an Author object in the main method, it is local
        // to the main method


        // but on line 30 the object is made with the reference
        // coming from the book object . the author object belong
        // to the Book object.
