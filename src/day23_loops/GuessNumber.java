  ...
  if they guess the number:
    ...
    */
    public static void main(String[] args) {
        ...
        }while (guess != secretNumber); // if guess is != to secretNumber so it will print it again and again till the
        // -->  guess become == secretNumber and the system will stop on that point
