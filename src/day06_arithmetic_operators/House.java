 ...
 */
    public class House {
        public static void main(String[] args) {
            String houseType = "Single House", address = "Fredericksburg VA, United State", Ratting = "5 out of 5";
            byte numberOfBedrooms = 4, numberOfBathroom = 3;
            int numberOfKitchen = 1, price = 1_000_000, zipCode = 22411;
            boolean thereIsBasement = true, isThereAttic = false, isTherePool = true, isTheHouseForSale = false,
                    isThereParkNearBy = true;


            System.out.println("  House Type\n\t" + houseType + " with " + numberOfBedrooms + " bedrooms, "
            ...
            System.out.println("\n\tIs it have Pool:\t" + isTherePool + "\n\tIs there Attic:\t"+isThereAttic+
                    ...
                    address+"\n\tIs it for sale:\t" +isTheHouseForSale);
        }
    }
