 ...
 */
    public static void main(String[] args) {
        ...
        for (int i = 0; i < nums.length; i++) {
            ...
            if (nums[i] != 0){
                fixed[index++] = nums[i]; // reading the element at position i of the nums array and storing it
                //-> into the fixed array and position index. after storing the value index variable is incremented
                // -> by 1
            }
        }
